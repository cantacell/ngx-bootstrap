import { Injectable, Component, Input, HostBinding, Inject, Output, EventEmitter, Directive, ElementRef, Renderer2, NgModule, ChangeDetectionStrategy, ChangeDetectorRef, ViewChild, forwardRef, ReflectiveInjector, TemplateRef, ApplicationRef, ComponentFactoryResolver, Injector, NgZone, isDevMode, ViewContainerRef, Host, HostListener, RendererFactory2, ViewEncapsulation, ViewChildren } from '@angular/core';
